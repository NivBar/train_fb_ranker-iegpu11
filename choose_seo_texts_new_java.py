...
def process_model(model, file_to_nick, archive_dir, model_dir, qrel_rankings):
    try:
        ...
        for pos in ["2", "3", "4"]: #TOMMY
            ...
            df_rank1 = df_rank1[df_rank1.docid.str.contains("ROUND-04")]  # test data
...
if __name__ == '__main__':
    ...
    run_command('find /lv_local/home/niv.b/train_fb_ranker/output_results/ranker_test_results/ -type f -exec rm {} +')
    archive_dir = "/lv_local/home/niv.b/train_fb_ranker/archive_test_w2v"

    qrel_rankings = pd.read_csv("feature_data_asrc_tommy.csv")
    ...
    # TODO: change back if testing in a large scale
    model_dir = "/lv_local/home/niv.b/train_fb_ranker/trained_models"
    # model_dir = "/lv_local/home/niv.b/train_fb_ranker/trained_models/chosen_bots"
    ...
    df.to_csv(
        f"/lv_local/home/niv.b/train_fb_ranker/output_results/ranker_test_results/bot_followup_asrc_test_FULL.csv",
        index=False)
    ...
    if not df.empty:
        df.to_csv("/lv_local/home/niv.b/train_fb_ranker/output_results/best_test_bots.csv",
                  index=True)
